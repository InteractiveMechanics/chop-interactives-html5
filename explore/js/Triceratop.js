function Triceratop(canvas) {
    ...
    I.bottom_image = new Sprite('default', new ImagePainter('./images/CHOP_DiggingUpDinos_tri-outline_btm-darken.png'));
    I.middle_image = new Sprite('default', new ImagePainter('./images/CHOP_DiggingUpDinos_tri-outline_middle-multiply.png'));
    I.top_image = new Sprite('default', new ImagePainter('./images/CHOP_DiggingUpDinos_tri-outline_top.png'));
