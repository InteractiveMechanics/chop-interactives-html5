...
function startFace() {
	setInterval(drawHero, 500, leftFaceContext, leftFaceCanvas, faceImage, 951, 862, 141, 0, 317.3, 287.3);
...
function startHat() {
	...
	setInterval(drawHero, 500, rightHatContext, rightHatCanvas, hatImage, 951, 862, 141, 0, 317.3, 287.2);
}
