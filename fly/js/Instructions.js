function Instructions(I) {
    ...
    I.sprite = new Sprite('instructions', new SpriteSheetPainter('images/Instructions-Fly.png', I.cells));
    ...
    I.draw = function (context) {
        ...
        if (this.count >= 60) {
            this.count = 0;
            this.paused = true;
            this.sprite = new Sprite('instructions', new SpriteSheetPainter('images/Instructions-Fly.png', I.cells));
        }
