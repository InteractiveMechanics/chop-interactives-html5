...
var imageRepository = new function() {
	...
	// Set images src
	this.background.src = "background@2x.png";
}
 ...
 */
function Background() {
	this.speed = 1.35; // Redefine speed of the background for panning
	...
	this.draw = function() {
		...
		//this.context.drawImage = (img.background, 0, img.height-Math.abs(100));
		this.context.clearRect(0, 0, window.innerWidth, window.innerHeight);
		this.context.drawImage(imageRepository.background, 0, this.y);
