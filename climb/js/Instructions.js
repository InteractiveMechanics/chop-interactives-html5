function Instructions(I) {
    ...
    I.cells = [
        ...
        { left: 1600, top: 1400, width: 200, height: 200 },
        { left: 1800, top: 1400, width: 200, height: 200 },

        { left: 0, top: 1600, width: 200, height: 200 },
        { left: 200, top: 1600, width: 200, height: 200 },
        { left: 400, top: 1600, width: 200, height: 200 },
        { left: 600, top: 1600, width: 200, height: 200 },
        { left: 800, top: 1600, width: 200, height: 200 },
        { left: 1000, top: 1600, width: 200, height: 200 },
        { left: 1200, top: 1600, width: 200, height: 200 },
        { left: 1400, top: 1600, width: 200, height: 200 },
        { left: 1600, top: 1600, width: 200, height: 200 },
        { left: 1800, top: 1600, width: 200, height: 200 },
    ];
    I.spritesheet = new Image();
    I.sprite = new Sprite('instructions', new SpriteSheetPainter('images/Instructions-Climb.png', I.cells));
    ...
    I.draw = function (context) {
        ...
        if (this.count >= 80) {
            this.count = 0;
            this.paused = true;
            this.sprite = new Sprite('instructions', new SpriteSheetPainter('images/Instructions-Climb.png', I.cells));
        }
